...
class App(object):
    ...
    def setup_GUI(self):
        ...
        self.message = Pixelizer('Hello World', screen_resolution)
    ...
    def run_app(self):
        ...
        while running:
            ...
            # Show 10 pixels per frame
            for i in range(10):
                self.message.show_one(self.screen, screen_resolution)
